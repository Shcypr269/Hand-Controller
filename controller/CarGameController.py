...
def game():
    ...
    while cap.isOpened():
        ...
        if len(co) == 2:
            ...
            #  controls based on hand positions with progressive steering
            tilt_threshold = 20  # degrees
            
            #  turn direction and intensity based on base_angle
            turn_direction = 0  # 0 = straight, -1 = left, 1 = right
            
            #  hand position patterns to determine direction
            ...
            # progressive steering based on angle
